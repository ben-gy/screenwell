...
export type EventCategory = 'system' | 'capture' | 'audio' | 'video' | 'record' | 'output';
...
const ALL_CATS: EventCategory[] = ['system', 'capture', 'audio', 'video', 'record', 'output'];
...
/** A logger bound to a category, matching the CaptureLogger signature. */
